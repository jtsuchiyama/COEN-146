...
// Date: 1/19/22
// Title: Lab3 - Setting up a TCP Client
// Description: The program connects and requests a file tranfer from the inputted server ip and port. 
// It sends the source filename to the server, and it receives and writes the file to a local file with 
// the name given by dest_file. 
